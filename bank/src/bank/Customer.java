...
public class Customer {
              ...
              */
              ...
              public static void main(String[] args) {
                           ...
                           ArrayList<Account> accountsList = readAccounts(fileScanner);
                           ...
                           if (accountsList.size() > 0) {
                                         ...
                                         while (true) {
                                                       ...
                                                       int index = getAccountIndex(accountsList, accountNum);
                                                       ...
                                                       if (index != -1) {
                                                                    ...
                                                                    doTransactions(account, keyboard);

                                                                    //saving updated info

                                                                    writeAccounts(accountsList);
